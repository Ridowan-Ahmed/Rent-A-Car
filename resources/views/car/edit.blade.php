...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{route('owner.show', $car->owner->slug)}}">{{$car->registration_num}}</a></li>
            <li class="breadcrumb-item active" aria-current="page">Edit</li>
        </ol>
    </nav>
    <h3 class="display-4">Edit {{$car->registration_num}}</h3>
    <div class="container img-thumbnail">
        {!! Form::model($car, ['method'=>'PATCH', 'action'=>['CarController@update', $car->registration_num]]) !!}
        ...
        {!! Form::close() !!}
        {!! Form::open(['method'=>'DELETE', 'action'=>['CarController@destroy', $car->registration_num]]) !!}
